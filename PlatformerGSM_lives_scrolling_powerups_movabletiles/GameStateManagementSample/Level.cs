...
namespace PlatformerGSM
{
    ...
    class Level : IDisposable
    {
        ...
        public Level(IServiceProvider serviceProvider, Stream fileStream, int levelIndex)
        {
            ...
            layers[1] = new Layer(Content, "Backgrounds/Layer1", 0.5f, 0.0ff);
            layers[2] = new Layer(Content, "Backgrounds/Layer2", 0.8f, 0.0ff);
...
const float ViewMargin = 0.45f;
            ...
            // Calculate how far to vertically scroll when the player is near the top or bottom
